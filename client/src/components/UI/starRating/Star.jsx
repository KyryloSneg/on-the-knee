    ...
    >
      <defs>
        <linearGradient id={gradId}>
          <stop offset={`${0}%`} stopColor="#f8ec00" stroke="#f8ec00" stopOpacity={1} />
          <stop offset={`${yellowFillPercent}%`} stopColor="#f8ec00" stroke="#f8ec00" stopOpacity={1} />
          <stop offset={`${yellowFillPercent}%`} stopColor="#D0D0D0" stopOpacity={1} />
          <stop offset={`${100}%`} stopColor="#D0D0D0" stopOpacity={1} />
        </linearGradient>
      </defs>
      <path 
        fill={`url(#${gradId})`} stroke="#f8ec00" 
